    ...
    createColorList: function (core, makeColor) {
        ...
        let list = '<div class="ke-list-inner">';
            ...
            '<form class="ke-submenu-form-group">' +
                ...
                '<button type="submit" class="ke-btn-primary _ke_color_picker_submit" title="' + lang.dialogBox.submitButton + '">' +
                    core.icons.checked +
                '</button>' +
                '<button type="button" class="ke-btn _ke_color_picker_remove" title="' + lang.toolbar.removeFormat + '">' +
                    core.icons.erase +
                '</button>' +
            '</form>' +
            '</div>';
