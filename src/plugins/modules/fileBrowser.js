...
export default {
  ...
  _drawFileList: function (url) {
    ...
    const xmlHttp = this.util.getXMLHttpRequest();
    fileBrowserPlugin._xmlHttp = this.util.getXMLHttpRequest();
  ...
  _drawListItem: function (items, update) {
    ...
    if (update) {
      ...
      fileBrowserContext.tagElements = fileBrowserContext.tagArea.querySelectorAll(
        "A"
      );
    }
  },
