...
(function (global, factory) {
  ...
  const resizing = {
    ...
    add: function (core) {
      ...
      context.resizing.resizeDiv = resize_div_container.querySelector(
        ".ke-modal-resize"
      );
      context.resizing.resizeDot = resize_div_container.querySelector(
        ".ke-resize-dot"
      );
      context.resizing.resizeDisplay = resize_div_container.querySelector(
        ".ke-resize-display"
      );
      ...
      context.resizing.alignMenuList = context.resizing.alignMenu.querySelectorAll(
        "button"
      );
    ...
    call_controller_resize: function (targetElement, plugin) {
      ...
      contextResizing.resizeButton.style.left =
        l + (overLeft < 0 ? overLeft : 0) + "px";

      if (overLeft < 0) {
        contextResizing.resizeButton.firstElementChild.style.left =
          20 - overLeft + "px";
      } else {
