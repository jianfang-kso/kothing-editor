...
export default {
    ...
    setController_resize: function () {
        ...
        resize_container.className = 'ke-resizing-container';
        resize_container.style.display = 'none';
        resize_container.innerHTML = '' +
            '<div class="ke-modal-resize">' +
    ...
    setController_button: function () {
        ...
        resize_button.innerHTML = '' +
            ...
            '<div class="ke-btn-group _se_resizing_btn_group">' +
            '   <button type="button" data-command="percent" data-value="1" class="ke-tooltip">' +
            '       <span>100%</span>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.resize100 + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="percent" data-value="0.75" class="ke-tooltip">' +
            '       <span>75%</span>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.resize75 + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="percent" data-value="0.5" class="ke-tooltip">' +
            '       <span>50%</span>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.resize50 + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="percent" data-value="0.25" class="ke-tooltip">' +
            '       <span>25%</span>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.resize25 + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="rotate" data-value="-90" class="ke-tooltip">' +
            '       <i class="ke-icon-rotate-left"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.rotateLeft + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="rotate" data-value="90" class="ke-tooltip">' +
            '       <i class="ke-icon-rotate-right"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.rotateRight + '</span></span>' +
            '   </button>' +
            '</div>' +
            '<div class="ke-btn-group">' +
            '   <button type="button" data-command="mirror" data-value="h" class="ke-tooltip">' +
            '       <i class="ke-icon-mirror-horizontal"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.mirrorHorizontal + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="mirror" data-value="v" class="ke-tooltip">' +
            '       <i class="ke-icon-mirror-vertical"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.mirrorVertical + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="onalign" class="ke-tooltip _se_resizing_align_button">' +
            ...
            '                   <i class="ke-icon-align-justify"></i>' +
            '                   <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.dialogBox.basic + '</span></span>' +
            '               </button></li>' +
            '               <li><button type="button" class="ke-btn-list ke-tooltip" data-command="align" data-value="left">' +
            '                   <i class="ke-icon-align-left"></i>' +
            '                   <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.dialogBox.left + '</span></span>' +
            '               </button></li>' +
            '               <li><button type="button" class="ke-btn-list ke-tooltip" data-command="align" data-value="center">' +
            '                   <i class="ke-icon-align-center"></i>' +
            '                   <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.dialogBox.center + '</span></span>' +
            '               </button></li>' +
            '               <li><button type="button" class="ke-btn-list ke-tooltip" data-command="align" data-value="right">' +
            '                   <i class="ke-icon-align-right"></i>' +
            '                   <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.dialogBox.right + '</span></span>' +
            '               </button></li>' +
            '           </ul>' +
            '       </div>' +
            '   </div>' +
            '   <button type="button" data-command="caption" class="ke-tooltip _se_resizing_caption_button">' +
            '       <i class="ke-icon-caption"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.dialogBox.caption + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="revert" class="ke-tooltip">' +
            '       <i class="ke-icon-revert"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.dialogBox.revertButton + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="update" class="ke-tooltip">' +
            '       <i class="ke-icon-modify"></i>' +
            '       <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.controller.edit + '</span></span>' +
            '   </button>' +
            '   <button type="button" data-command="delete" class="ke-tooltip">' +
    ...
    call_controller_resize: function (targetElement, plugin) {
        ...
        this.util.removeClass(contextResizing.alignButtonIcon, 'ke-icon-align\\-[a-z]+');
        this.util.addClass(contextResizing.alignButtonIcon, 'ke-icon-align-' + (align === 'basic' ? 'justify' : align));
