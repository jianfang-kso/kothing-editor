...
export default {
  ...
  add: function (core) {
    ...
    let resize_handles = context.resizing.resizeDot.querySelectorAll("span");
    context.resizing.resizeHandles = context.resizing.resizeDot.querySelectorAll(
      "span"
    );
  ...
  setTransformSize: function (element, width, height) {
    ...
    if (percentage && !isVertical) {
      ...
      this.plugins[this.context.resizing._resize_plugin].cancelPercentAttr.call(
        this
      );
      this.plugins[this.context.resizing._resize_plugin].setSize.call(
        this,
