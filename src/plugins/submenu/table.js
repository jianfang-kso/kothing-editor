...
export default {
  ...
  add: function (core, targetElement) {
    ...
    context.table.tableHighlight = listDiv.querySelector(
      ".ke-table-size-highlighted"
    );
    context.table.tableUnHighlight = listDiv.querySelector(
      ".ke-table-size-unhighlighted"
    );
    context.table.tableDisplay = listDiv.querySelector(
    ...
    context.table.resizeButton = tableController.querySelector(
      "._ke_table_resize"
    );
    context.table.resizeText = tableController.querySelector(
      "._ke_table_resize > span > span"
    );
    context.table.columnFixedButton = tableController.querySelector(
      "._ke_table_fixed_column"
    );
    context.table.headerButton = tableController.querySelector(
      "._ke_table_header"
    );
    tableController.addEventListener("mousedown", core.eventStop);

    /** set resizing */
    let resizeDiv = this.setController_tableEditor.call(
      core,
      context.table.cellControllerTop
    );
    context.table.resizeDiv = resizeDiv;
    context.table.splitMenu = resizeDiv.querySelector(".ke-btn-group-sub");
    context.table.mergeButton = resizeDiv.querySelector(
      "._ke_table_merge_button"
    );
    context.table.splitButton = resizeDiv.querySelector(
      "._ke_table_split_button"
    );
    context.table.insertRowAboveButton = resizeDiv.querySelector(
      "._ke_table_insert_row_a"
    );
    context.table.insertRowBelowButton = resizeDiv.querySelector(
    ...
    tablePicker.addEventListener(
      "mousemove",
      this.onMouseMove_tablePicker.bind(core)
    );
  ...
  setPositionControllerTop: function (tableElement) {
    ...
    tableController.style.top =
      offset.top - tableController.offsetHeight - 2 + "px";
  },
  ...
  setPositionControllerDiv: function (tdElement, reset) {
    ...
    if (contextTable.cellControllerTop) {
      ...
      resizeDiv.style.left =
        offset.left + contextTable.tableController.offsetWidth + "px";
    } else {
      const offset = this.util.getOffset(
        tdElement,
        this.context.element.wysiwygFrame
      ...
      const overLeft =
        ...
        (resizeDiv.offsetLeft + resizeDiv.offsetWidth);
      if (overLeft < 0) {
