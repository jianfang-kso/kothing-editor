...
export default {
    ...
    setSubmenu: function () {
        ...
        listDiv.innerHTML = '' +
            ...
            '       <li><button type="button" class="ke-btn-list ke-tooltip" data-command="OL">' +
            '           <i class="ke-icon-list-number"></i>' +
            '           <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.toolbar.orderList + '</span></span>' +
            '       </button></li>' +
            '       <li><button type="button" class="ke-btn-list ke-tooltip" data-command="UL">' +
            '           <i class="ke-icon-list-bullets"></i>' +
            '           <span class="ke-tooltip-inner"><span class="ke-tooltip-text">' + lang.toolbar.unorderList + '</span></span>' +
            '       </button></li>' +
            '   </ul>' +
            '</div>';
