...
export default {
  ...
  /**
   * @description Initialize property of kothing-editor elements
   * @param {Object} options Options
  ...
  _initElements: function(options, topDiv, toolBar, toolBarArrow, initHTML) {
    ...
    if (typeof options.position === "string")
      topDiv.style.position = options.position;
    ...
    if (!options.iframe) {
      ...
      wysiwygDiv.addEventListener("load", function() {
        ...
        this.contentDocument.head.innerHTML =
          ...
          "<title></title>" +
          cssTags;
        this.contentDocument.body.className = "kothing-editor-editable";
  ...
  _initOptions: function(element, options) {
    ...
    options.toolbarWidth = options.toolbarWidth
      ? /^\d+$/.test(options.toolbarWidth)
        ? options.toolbarWidth + "px"
        : options.toolbarWidth
      : "auto";
    options.stickyToolbar =
      /balloon/i.test(options.mode) ||
      options.stickyToolbar === undefined ||
      options.stickyToolbar === null
        ? -1
        : /^\d+/.test(options.stickyToolbar)
        ? options.stickyToolbar.toString().match(/\d+/)[0] * 1
        : options.stickyToolbar === true
        ? 0
        : -1;
    // bottom resizing bar
    options.resizingBar =
    ...
    options.maxCharCount =
      /^\d+$/.test(options.maxCharCount) && options.maxCharCount > -1
    ...
    options.width = options.width
      ...
      : "100%";
    options.minWidth =
      (/^\d+$/.test(options.minWidth)
        ? options.minWidth + "px"
        : options.minWidth) || "";
    options.maxWidth =
      (/^\d+$/.test(options.maxWidth)
        ? options.maxWidth + "px"
        : options.maxWidth) || "";
    options.height = options.height
      ...
      : "auto";
    options.minHeight =
      (/^\d+$/.test(options.minHeight)
        ? options.minHeight + "px"
        : options.minHeight) || "";
    options.maxHeight =
      (/^\d+$/.test(options.maxHeight)
    ...
    options.imageWidth =
      options.imageWidth && /\d+/.test(options.imageWidth)
        ? options.imageWidth.toString().match(/\d+/)[0]
        : "auto";
    ...
    options.imageUploadSizeLimit = /\d+/.test(options.imageUploadSizeLimit)
      ? options.imageUploadSizeLimit.toString().match(/\d+/)[0] * 1
      : null;
    // video
    options.videoResizing =
      options.videoResizing === undefined ? true : options.videoResizing;
    options.videoWidth =
      options.videoWidth && /\d+/.test(options.videoWidth)
        ? options.videoWidth.toString().match(/\d+/)[0]
        : 560;
    options.videoHeight =
      options.videoHeight && /\d+/.test(options.videoHeight)
        ? options.videoHeight.toString().match(/\d+/)[0]
        : 315;
  ...
  _defaultButtons: function(lang) {
    return {
      ...
      underline: [
        "_se_command_underline",
        lang.toolbar.underline + " (CTRL+U)",
        "INS",
        "",
      ...
      strike: [
        "_se_command_strike",
        lang.toolbar.strike + " (CTRL+SHIFT+S)",
        "DEL",
        "",
      ...
      undo: [
        "_se_command_undo",
        lang.toolbar.undo + " (CTRL+Z)",
        "undo",
        "",
        '<i class="ke-icon-undo"></i>',
        true,
      ],

      redo: [
        "_se_command_redo",
        lang.toolbar.redo + " (CTRL+Y / CTRL+SHIFT+Z)",
        "redo",
        "",
        '<i class="ke-icon-redo"></i>',
        true,
      ],
      ...
      save: [
        ...
        "save",
        "",
        '<i class="ke-icon-save"></i>',
        true,
      ],

      /** plugins - submenu */
      font: [
        "ke-btn-select ke-btn-tool-font _se_command_font_family",
        lang.toolbar.font,
        "font",
        "submenu",
        '<span class="txt">' +
          lang.toolbar.font +
          '</span><i class="ke-icon-arrow-down"></i>',
      ],
      ...
      formatBlock: [
        ...
        "formatBlock",
        "submenu",
        '<span class="txt _se_command_format">' +
          lang.toolbar.formats +
          '</span><i class="ke-icon-arrow-down"></i>',
      ],
      ...
      fontSize: [
        ...
        "fontSize",
        "submenu",
        '<span class="txt _se_command_font_size">' +
          lang.toolbar.fontSize +
          '</span><i class="ke-icon-arrow-down"></i>',
      ],
  ...
  _createModuleGroup: function(oneModule) {
    ...
    oDiv.className =
      "ke-btn-module" + (oneModule ? "" : " ke-btn-module-border");
