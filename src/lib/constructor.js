...
export default {
  ...
  init: function(element, options) {
    ...
    // toolbar
    const tool_bar = this._createToolBar(doc, options.toolBarItem, options.plugins, options);
  ...
  _initOptions: function(element, options) {
    ...
    options.charCounterType =
      typeof options.charCounterType === 'string' ? options.charCounterType : 'char';
    options.charCounterLabel =
      typeof options.charCounterLabel === 'string' ? options.charCounterLabel.trim() : null;
    ...
    options.width = options.width
      ...
      : '100%';
    options.minWidth =
      (util.isNumber(options.minWidth) ? options.minWidth + 'px' : options.minWidth) || '';
    options.maxWidth =
      (util.isNumber(options.maxWidth) ? options.maxWidth + 'px' : options.maxWidth) || '';
    /** Height size */
    options.height = options.height
      ...
      : 'auto';
    options.minHeight =
      (util.isNumber(options.minHeight) ? options.minHeight + 'px' : options.minHeight) || '';
    options.maxHeight =
      (util.isNumber(options.maxHeight) ? options.maxHeight + 'px' : options.maxHeight) || '';
    ...
    options.fontSizeUnit =
      typeof options.fontSizeUnit === 'string' ? options.fontSizeUnit.trim() || 'px' : 'px';
    /** Image */
    ...
    options.imageUploadUrl =
      typeof options.imageUploadUrl === 'string' ? options.imageUploadUrl : null;
    ...
    options.imageGalleryUrl =
      typeof options.imageGalleryUrl === 'string' ? options.imageGalleryUrl : null;
    /** Video */
    ...
    options.videoUploadUrl =
      typeof options.videoUploadUrl === 'string' ? options.videoUploadUrl : null;
    ...
    options.audioUploadUrl =
      typeof options.audioUploadUrl === 'string' ? options.audioUploadUrl : null;
    ...
    options.shortcutsDisable =
      Array.isArray(options.shortcutsDisable) && options.shortcutsDisable.length > 0
  ...
  _defaultButtons: function(options) {
    ...
    return {
      ...
      bold: [
        '_ke_command_bold',
        lang.toolbar.bold + (shortcutsDisable.indexOf('bold') > -1 ? '' : ' (' + cmd + '+B)'),
        'STRONG',
        '',
        icons.bold,
      ],
      underline: [
        ...
        lang.toolbar.underline +
          (shortcutsDisable.indexOf('underline') > -1 ? '' : ' (' + cmd + '+U)'),
        'U',
        '',
        icons.underline,
      ],
      italic: [
        '_ke_command_italic',
        lang.toolbar.italic + (shortcutsDisable.indexOf('italic') > -1 ? '' : ' (' + cmd + '+I)'),
        'EM',
        '',
        icons.italic,
      ],
      strike: [
        '_ke_command_strike',
        lang.toolbar.strike +
          (shortcutsDisable.indexOf('strike') > -1 ? '' : ' (' + cmd + '+SHIFT+S)'),
        'DEL',
        '',
        icons.strike,
      ],
      ...
      indent: [
        '_ke_command_indent',
        lang.toolbar.indent + (shortcutsDisable.indexOf('indent') > -1 ? '' : ' (' + cmd + '+])'),
        'indent',
        '',
        icons.outdent,
      ],
      outdent: [
        '_ke_command_outdent',
        lang.toolbar.outdent + (shortcutsDisable.indexOf('indent') > -1 ? '' : ' (' + cmd + '+[)'),
        'outdent',
        '',
        icons.indent,
      ],
      ...
      undo: [
        ...
        lang.toolbar.undo + (shortcutsDisable.indexOf('undo') > -1 ? '' : ' (' + cmd + '+Z)'),
        'undo',
        '',
        icons.undo,
      ],
      redo: [
        ...
        lang.toolbar.redo +
          (shortcutsDisable.indexOf('undo') > -1 ? '' : ' (' + cmd + '+Y / ' + cmd + '+SHIFT+Z)'),
        'redo',
        '',
        icons.redo,
      ],
