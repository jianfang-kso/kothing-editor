...
let ssss = kothintEditor.create(("sample1"), {
    plugins: plugins, //[kothingEditorNpsButtonBgColor, kothingEditorNpsButtonFontColor, kothingEditorNpsButtonFontSize],
    // font: [
...
window.sun_create4 = function () {
    ...
    s4 = kothintEditor.create(win.document.querySelector('#editor4'), {
        plugins: plugins,
        toolBarItem: [
