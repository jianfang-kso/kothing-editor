...
export default {
  ...
  setSubmenu: function () {
    ...
    listDiv.className = 'ke-list-layer ke-list-align';
    listDiv.innerHTML = '' + 
            `<div class="ke-list-inner" style="width: auto;">
               ...
               <ul class="ke-list-basic">
                   ...
                   <li><button type="button" class="ke-btn ke-tooltip" style="margin-top: 10px;">
                       <span>Done</span>
                       <span class="ke-tooltip-inner">
                           <span class="ke-tooltip-text">Append item</span>
                       </span>
                   </button></li>
               </ul> 
               </form>
