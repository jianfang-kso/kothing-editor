...
var _default = {
  ...
  setSubmenu: function setSubmenu() {
    ...
    listDiv.innerHTML = '' + '<div class="ke-list-inner">' + '<ul class="ke-list-basic">' + '<li><button type="button" class="ke-btn-list ke-tooltip" data-command="OL" title="' + lang.toolbar.orderList + '">' + this.icons.list_number + '</button></li>' + '<li><button type="button" class="ke-btn-list ke-tooltip" data-command="UL" title="' + lang.toolbar.unorderList + '">' + this.icons.list_bullets + '</button></li>' + '</ul>' + '</div>';
    return listDiv;
  },
